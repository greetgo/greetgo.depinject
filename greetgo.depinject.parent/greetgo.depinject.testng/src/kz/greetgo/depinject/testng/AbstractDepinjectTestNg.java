...
public abstract class AbstractDepinjectTestNg {
  public AbstractDepinjectTestNg() {
    try {
      prepareDepinjectTestNg(this, getSrcTempDir());
    } catch (Exception e) {
  ...
  private static void prepareDepinjectTestNg(AbstractDepinjectTestNg testNgTest, String srcTempDir) throws Exception {
