...
//      out.tab(tab2).stn("if (e instanceof java.lang.RuntimeException) throw (java.lang.RuntimeException) e;");
  ...
  public void calculatesBeanPreparationPriority(List<BeanCreation> preparations) {
    {
      ...
      kz.greetgo.depinject.ann.BeanPreparationPriority annotation = Utils.getAnnotation(
        beanClass, kz.greetgo.depinject.ann.BeanPreparationPriority.class
      );
      if (annotation != null) {
  ...
  private static boolean isBeanPreparation(Class<?> rawClass) {
    return kz.greetgo.depinject.BeanPreparation.class == rawClass;
  }
