...
import static kz.greetgo.depinject.ap.engine.BeanReferencePlace.placeInAnnotationFactoredBy;
import static kz.greetgo.depinject.ap.engine.BeanReferencePlace.placeInBeanFactory;
...
public class BeanCreationCollector {
  ...
  private void applyAnnotationScanPackage(Class<?> beanConfig) {
    kz.greetgo.depinject.ann.ScanPackage scanPackage
      = beanConfig.getAnnotation(kz.greetgo.depinject.ann.ScanPackage.class);
